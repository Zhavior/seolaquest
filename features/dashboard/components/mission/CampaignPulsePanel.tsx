...
> = {
  ...
  blocked: { label: 'Blocked', tone: 'bg-[#FFE0C7] text-ink' },
...
export function CampaignPulsePanel({
  ...
  return (
    <motion.section
      ...
      className="w-full min-w-0 border-4 border-outline bg-card shadow-brutal-lg"
    >
      <div className="flex flex-col gap-4 border-b-4 border-outline bg-highlight p-4 sm:flex-row sm:items-start sm:justify-between sm:p-5">
        <div className="min-w-0">
          <p className="text-[10px] font-black uppercase tracking-[0.18em] text-ink/60 sm:text-[11px]">
            Campaign pulse
          </p>
          <h2
            id="campaign-pulse-heading"
            className="mt-1 text-xl font-black uppercase leading-tight text-ink sm:text-2xl"
          >
            Current campaign state
          </h2>
          <p className="mt-2 max-w-xl text-sm font-bold leading-relaxed text-ink/75">
            {pulse.summary}
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          <span
            className={`inline-flex min-h-11 items-center border-2 border-outline px-3 py-2 text-xs font-black uppercase shadow-brutal-sm ${trend.tone}`}
          >
            <Activity className="mr-2 size-4 shrink-0" aria-hidden />
            {trend.label}
          </span>
          <span className="inline-flex min-h-11 items-center border-2 border-outline bg-black px-3 py-2 text-xs font-black uppercase text-[#FFE600] shadow-brutal-sm">
            {creditReading}
          </span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-0 md:grid-cols-3">
        <div className="border-b-4 border-outline p-4 md:border-b-0 md:border-r-4 md:p-5">
          <p className="text-[10px] font-black uppercase tracking-widest text-ink/55">Measured counts</p>
          <ul className="mt-3 space-y-2 text-sm font-bold text-ink">
            ...
            {planLabel ? <li className="text-ink/70">{planLabel}</li> : null}
          </ul>
        </div>

        <div className="border-b-4 border-outline p-4 md:border-b-0 md:border-r-4 md:p-5">
          <p className="mb-3 flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-ink/55">
      ...
      <div className="flex flex-col gap-3 border-t-4 border-outline bg-inset p-4 sm:flex-row sm:items-center sm:justify-between sm:p-5">
        ...
        <Link
          href="/app/runs"
          className="inline-flex min-h-11 items-center justify-center border-2 border-outline bg-card px-4 py-2 text-xs font-black uppercase shadow-brutal-sm hover:bg-highlight"
        >
          Open run history
        </Link>
      </div>

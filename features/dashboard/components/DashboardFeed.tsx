...
function DashboardFeedComponent({
  ...
  return (
    <motion.section
      ...
      initial="hidden"
      animate="show"
      className="relative overflow-hidden border-4 border-black bg-[#FFF8D9] p-6 md:p-8 shadow-[6px_6px_0_0_#000]"
    >
      <div className="flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between mb-8">
        <div className="flex items-start gap-4">
          <div className="mt-1 border-4 border-black bg-[#FF5722] p-3 shadow-[4px_4px_0_0_#000] md:p-4">
            <Flame className="h-8 w-8 text-white md:h-10 md:w-10" />
          </div>
          ...
          <div className="min-w-0">
            ...
            <p className="text-lg md:text-xl font-bold uppercase bg-black text-white inline-block px-4 py-1 -rotate-1 border-2 border-black mt-2">
              Active Buyer Signals & Triage Pipeline
            </p>

            <div className="mt-6 flex flex-wrap items-center gap-3">
              <div className="inline-flex items-center gap-2 border-3 border-black bg-[#FFE600] px-3.5 py-2 text-xs font-black uppercase shadow-[3px_3px_0_0_#000]">
                <Crosshair className="h-4 w-4" />
                {filteredLeads.length} active {filteredLeads.length === 1 ? 'signal' : 'signals'}
              </div>

              <div className="inline-flex items-center gap-2 border-3 border-black bg-[#06B6D4] px-3.5 py-2 text-xs font-black uppercase shadow-[3px_3px_0_0_#000] text-black">
                <Sparkles className="h-4 w-4" />
                Fresh intent only
              </div>

              <div className="inline-flex items-center gap-2 border-3 border-black bg-white px-3.5 py-2 text-xs font-black uppercase shadow-[3px_3px_0_0_#000]">
          ...
          {platforms.map((platform) => {
            ...
            return (
              <button
                ...
                className={`flex min-h-[44px] items-center gap-2 border-3 border-black px-4 py-2 text-xs font-black uppercase shadow-[3px_3px_0_0_#000] transition active:translate-x-[2px] active:translate-y-[2px] active:shadow-none ${

...
export default function ApiKeyVault() {
  return (
    <main className="mx-auto min-h-screen max-w-4xl space-y-6 p-4 md:p-8">
      <section className="border border-outline bg-accent p-8 shadow-brutal-lg rounded-xl">
        <div className="flex items-center gap-3">
          <KeyRound className="h-9 w-9" />
          <h1 className="text-4xl font-semibold normal-case">API key vault unavailable</h1>
        </div>
      ...
      <section className="border border-outline bg-card p-6 shadow-brutal-lg rounded-xl">
        <h2 className="flex items-center gap-2 text-xl font-semibold normal-case">
          <ShieldAlert className="h-6 w-6 text-ink-muted" /> Fail-closed status
        </h2>

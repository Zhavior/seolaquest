...
export const metadata = {
  title: 'Pricing | CoQuest',
  description: 'CoQuest plan availability and manual scan entitlements.',
}
  ...
  return (
    <div className="min-h-screen bg-[#F4F0EA] text-black">
      <main className="mx-auto max-w-6xl px-5 py-12 sm:py-20">
        <Link href="/" className="text-sm font-black uppercase underline decoration-4 underline-offset-4">← CoQuest home</Link>
        <header className="mt-8 max-w-4xl">
          ...
          <p className="mt-5 max-w-3xl text-lg font-bold text-zinc-700">CoQuest stores keywords for free. Manual provider-backed scans require verified paid access and available scan credits. A source match is not a qualified customer.</p>
        </header>
        ...
        <section className="mt-10 grid gap-6 md:grid-cols-2">
          ...
          <article className="border-4 border-black bg-white p-6 shadow-[6px_6px_0_0_#000]">
            ...
            <p className="mt-3 font-bold text-zinc-700">Available invoices and receipts are accessed through Stripe billing management after account setup. Consumed credits are not automatically restored. For billing disputes or refund requests, email <a className="underline decoration-2 underline-offset-2" href="mailto:support@coquest.ai?subject=CoQuest%20billing%20support">support@coquest.ai</a>; applicable consumer rights are not waived.</p>
          </article>
        </section>

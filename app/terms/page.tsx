...
export default function TermsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F4F0EA] text-black font-sans pb-12">
      {/* Top Banner Nav */}
      <div className="border-b-4 border-black bg-[#FFE600] px-4 py-3">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 text-xs font-black uppercase">
            <span className="border-2 border-black bg-white px-2.5 py-1 shadow-[2px_2px_0_0_#000]">
              ⚖️ LEGAL GOVERNANCE
            </span>
          </div>
        </div>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 pt-10 sm:pt-14 space-y-10">
        ...
        <div className="border-4 border-black bg-white p-6 sm:p-10 shadow-[8px_8px_0_0_#000] relative overflow-hidden">
          ...
          <div className="relative z-10 space-y-4">
            <div className="inline-flex items-center gap-2 border-2 border-black bg-[#A3E635] px-3 py-1 text-xs font-black uppercase shadow-[2px_2px_0_0_#000]">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-4">
              <button
                ...
                className="flex min-h-11 items-center gap-2 border-3 border-black bg-[#FFE600] px-4 py-2.5 text-xs font-black uppercase shadow-[4px_4px_0_0_#000] hover:bg-[#00FFFF] active:translate-x-0.5 active:translate-y-0.5 active:shadow-none transition-all cursor-pointer"
              >
              ...
              <a
                ...
                className="flex items-center gap-1.5 border-3 border-black bg-white px-4 py-2.5 text-xs font-black uppercase shadow-[4px_4px_0_0_#000] hover:bg-zinc-100 transition-all"
              >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <a
            ...
            onClick={() => sfx.playHoverBlip()}
            className="border-3 border-black bg-white p-4 shadow-[4px_4px_0_0_#000] hover:bg-[#FFF7AA] transition-all flex flex-col justify-between"
          >
            <div className="flex items-center justify-between">
              <span className="font-black text-sm uppercase">1. Guild Code</span>
              <ShieldCheck size={20} className="text-purple-600" />
            </div>
            <p className="text-xs font-bold text-zinc-600 mt-2">Ethical B2B hunting standards & system fair play.</p>
          </a>
          ...
          >
            ...
            <p className="text-xs font-bold text-zinc-600 mt-2">Current enabled billing catalog and credit terms.</p>
          </a>
          ...
          >
            ...
            <p className="text-xs font-bold text-zinc-600 mt-2">Strict anti-scraping & anti-spam guidelines.</p>
          </a>
        </div>

        {/* 1. MASTER GUILD CODE OF CONDUCT */}
        <section id="code-of-conduct" className="border-4 border-black bg-white p-6 sm:p-8 shadow-[6px_6px_0_0_#000] space-y-6">
          <div className="flex items-center gap-3 border-b-4 border-black pb-4">
            ...
            <div>
              <h2 className="text-2xl font-black uppercase tracking-tight text-black">Master Guild Code of Conduct</h2>
              <p className="text-xs font-bold text-zinc-500 uppercase">Honor, Speed, and Ethical Lead Hunting</p>
            </div>
          </div>
          ...
          <div className="space-y-4 text-sm font-bold text-zinc-800 leading-relaxed">
            ...
            <ul className="space-y-3 pl-2">
              <li className="flex items-start gap-3 border-2 border-black bg-[#F4F4F5] p-3 shadow-[2px_2px_0_0_#000]">
                ...
                <div>
                  <span className="font-black uppercase text-black">Fair Play & Rate Integrity:</span> Hunters shall not attempt to breach or alter API rate limits using distributed proxy networks, key pooling, or concurrent request spikes designed to degrade service performance.
                </div>
              </li>
              ...
              <li className="flex items-start gap-3 border-2 border-black bg-[#F4F4F5] p-3 shadow-[2px_2px_0_0_#000]">
                <CheckCircle2 size={18} className="text-green-600 shrink-0 mt-0.5" />
                <div>
                  <span className="font-black uppercase text-black">Honorable Outreach:</span> Stored source matches must be used solely for relevant, non-deceptive B2B communication. Impersonation of third-party organizations or deceptive automation may result in account restriction under these terms.
                </div>
              </li>
              ...
              <li className="flex items-start gap-3 border-2 border-black bg-[#F4F4F5] p-3 shadow-[2px_2px_0_0_#000]">
                <CheckCircle2 size={18} className="text-green-600 shrink-0 mt-0.5" />
                <div>
                  <span className="font-black uppercase text-black">Security Vigilance:</span> Public API credentials are not currently offered. Do not attempt to access internal endpoints or credentials, and report suspected compromise through an available support channel.
                </div>
              </li>
            </ul>
          </div>
        ...
        <section id="billing-terms" className="border-4 border-black bg-white p-6 sm:p-8 shadow-[6px_6px_0_0_#000] space-y-6">
          <div className="flex items-center gap-3 border-b-4 border-black pb-4">
            ...
            <div>
              <h2 className="text-2xl font-black uppercase tracking-tight text-black">Subscription Billing & Tier Terms</h2>
              <p className="text-xs font-bold text-zinc-500 uppercase">Free access and the enabled paid Beta</p>
            </div>
          </div>
          ...
          <div className="space-y-4 text-sm font-bold text-zinc-800 leading-relaxed">
            ...
            <div className="border-3 border-black bg-[#F4F4F5] p-4 space-y-4 shadow-[4px_4px_0_0_#000]">
              <div className="flex items-center justify-between border-b-2 border-black pb-2">
                <span className="font-black uppercase text-xs text-zinc-600">CURRENT SELLABLE CATALOG</span>
                <span className="text-xs font-bold text-zinc-700">Server-enforced</span>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div className="border-3 border-black bg-[#A3E635] p-4 shadow-[3px_3px_0_0_#000]">
              ...
              <div className="border-3 border-black bg-[#FFF7AA] p-4 text-xs font-bold">
            ...
            <div className="space-y-3 pt-2">
              <h3 className="font-black uppercase text-base text-black flex items-center gap-2">
        ...
        <section id="mana-policy" className="border-4 border-black bg-white p-6 sm:p-8 shadow-[6px_6px_0_0_#000] space-y-6">
          <div className="flex items-center gap-3 border-b-4 border-black pb-4">
            ...
            <div>
              <h2 className="text-2xl font-black uppercase tracking-tight text-black">Usage-Based Mana & Cancellation Rules</h2>
              <p className="text-xs font-bold text-zinc-500 uppercase">Non-Refundable Edge Consumption & Account Self-Service</p>
            </div>
          </div>

          <div className="space-y-4 text-sm font-bold text-zinc-800 leading-relaxed">
            <div className="border-3 border-black bg-[#FFF7AA] p-4 shadow-[4px_4px_0_0_#000] flex items-start gap-3">
              <AlertTriangle size={24} className="text-amber-700 shrink-0 mt-0.5" />
              <div className="space-y-1">
                <span className="font-black uppercase text-black text-sm">CRITICAL NOTICE: MANA NON-REFUNDABILITY</span>
            ...
            <div className="space-y-3 pt-2">
              <h3 className="font-black uppercase text-base text-black">Account Cancellation Procedures</h3>
              <p>
        ...
        <section id="acceptable-use" className="border-4 border-black bg-white p-6 sm:p-8 shadow-[6px_6px_0_0_#000] space-y-6">
          <div className="flex items-center gap-3 border-b-4 border-black pb-4">
            ...
            <div>
              <h2 className="text-2xl font-black uppercase tracking-tight text-black">Acceptable Use Policy (AUP)</h2>
              <p className="text-xs font-bold text-zinc-500 uppercase">Strict Anti-Scraping, Anti-Spam & API Safeguards</p>
            </div>
          </div>
          ...
          <div className="space-y-4 text-sm font-bold text-zinc-800 leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              <div className="border-3 border-black bg-red-50 p-4 shadow-[3px_3px_0_0_#000]">
        ...
        <div className="border-4 border-black bg-[#FFE600] p-6 shadow-[6px_6px_0_0_#000] flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="space-y-1 text-center sm:text-left">
            <span className="font-black uppercase text-base text-black">Questions regarding Guild Terms?</span>
            <p className="text-xs font-bold text-zinc-800">Review Privacy Policies or contact our Guildmaster support team.</p>
          </div>
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/privacy"
              onClick={() => sfx.playCoinDrop()}
              className="border-3 border-black bg-white px-4 py-2 font-black uppercase text-xs shadow-[3px_3px_0_0_#000] hover:bg-zinc-100 transition-all"
            >
              Privacy Policy
            </Link>
            <Link
              href="/api-terms"
              onClick={() => sfx.playCoinDrop()}
              className="border-3 border-black bg-black text-[#FFE600] px-4 py-2 font-black uppercase text-xs shadow-[3px_3px_0_0_#000] hover:bg-zinc-800 transition-all flex items-center gap-1"
            >
              <span>API Terms</span>
              <ArrowRight size={14} />
            </Link>

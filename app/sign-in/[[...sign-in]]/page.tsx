...
export const metadata: Metadata = {
  title: 'Sign In | CoQuest',
  description: 'Sign in to resume your saved CoQuest workspace.',
}
  ...
  return (
    <main className="flex min-h-screen w-full flex-col items-center justify-center bg-[#F4F0EA] px-4 py-8 text-black">
      ...
      <section aria-labelledby="sign-in-heading" className="flex w-full max-w-md flex-col items-center">
        <div className="mb-4 w-full border-3 border-black bg-[#FFE600] p-4 text-center shadow-[4px_4px_0_0_#000]">

...
export default function BountyCard({
  ...
  return (
    ...
    >
      <header className="border-b-4 border-black bg-black p-3.5 sm:p-4 text-white">
      ...
      <div className={`flex-1 p-4 sm:p-6 ${contentStyle}`}>
        <p className="text-base sm:text-lg font-bold leading-relaxed text-gray-900 break-word-safe">&quot;{lead.content}&quot;</p>
        <div className="mt-4 sm:mt-5 flex flex-wrap gap-2">
          <span className="border-2 border-black bg-[#FFE600] px-2.5 py-1 text-xs font-black uppercase break-word-safe">
        ...
        <p className="mt-3 sm:mt-4 text-xs font-bold leading-relaxed text-zinc-600">
          CoQuest has not measured an intent score, social engagement count, deal value, or response SLA for this record.
        </p>
      </div>

      <div className="space-y-2.5 sm:space-y-3 border-t-4 border-black bg-white p-3.5 sm:p-4">
        <div className="flex gap-2.5 sm:gap-3">
          <motion.button
            ...
            disabled={isPending}
            className="flex flex-1 min-h-[44px] items-center justify-center gap-2 border-4 border-black bg-[#A3E635] py-2.5 text-xs sm:text-sm font-black uppercase text-black shadow-[3px_3px_0_0_#000] sm:shadow-[4px_4px_0_0_#000] disabled:cursor-not-allowed disabled:opacity-50"
          >
          ...
          <a
            ...
            className="flex min-h-[44px] w-12 sm:w-14 items-center justify-center border-4 border-black bg-[#06B6D4] shadow-[3px_3px_0_0_#000] sm:shadow-[4px_4px_0_0_#000]"
          >
        ...
        <div className="flex flex-col sm:flex-row gap-2.5 sm:gap-3">
          <motion.button
            ...
            disabled={isPending}
            className="flex flex-1 min-h-[44px] items-center justify-center gap-2 border-4 border-black bg-[#A855F7] py-2 text-xs font-black uppercase text-black shadow-[3px_3px_0_0_#000] sm:shadow-[4px_4px_0_0_#000] disabled:cursor-not-allowed disabled:opacity-50"
          >
          ...
          <motion.button
            ...
            disabled={isPending}
            className="flex flex-1 min-h-[44px] items-center justify-center gap-2 border-4 border-black bg-black py-2 text-xs font-black uppercase text-white shadow-[3px_3px_0_0_#A3E635] sm:shadow-[4px_4px_0_0_#A3E635] disabled:cursor-not-allowed disabled:opacity-50"
          >

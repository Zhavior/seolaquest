      ...
      <div className="border-b-4 border-black bg-black px-6 py-8 text-white">
        <div className="mx-auto grid max-w-7xl gap-6 md:grid-cols-[minmax(0,1fr)_auto] md:items-start md:gap-10">
          ...
          <div className="flex flex-col items-start gap-4 md:items-end md:justify-start">
            <Link
              href="/sign-up"
              className="inline-flex items-center gap-2 border-4 border-black bg-[#FFE600] px-5 py-3 text-sm font-black uppercase text-black shadow-[6px_6px_0_0_#ff5a36] transition-transform duration-150 hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[8px_8px_0_0_#ff5a36]"
            >
              Start free
              <ArrowRight size={16} />
            </Link>
              ...
              {links.map((item) => {
                ...
                return (
                  <Link
                    key={item.href}
                    href={item.href}
                    className="inline-flex items-center gap-2 border-2 border-white bg-white px-3 py-2 text-xs font-black uppercase text-black shadow-[2px_2px_0_0_#FFE600]"
                  >
